...
/*TO verify whether application allows multiple users to get registered as Student using Data base as Data provider
*/
...
public class RegisterTests_DBTest {
	...
	public void validRegisterTest(String firstName, String lastName, String email, String userName, String password, String confirmPassword, String phone, String language, String profile) throws InterruptedException {
		...
		registerPOM.selectProfile(profile);
		screenShot.captureScreenShot("Before Registarion_Excel");
		Thread.sleep(2000);
